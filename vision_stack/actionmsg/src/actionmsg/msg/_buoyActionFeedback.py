"""autogenerated by genpy from actionmsg/buoyActionFeedback.msg. Do not edit."""
import sys
...
class buoyActionFeedback(genpy.Message):
  ...
  _type = "actionmsg/buoyActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','actionmsg/buoyFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = actionmsg.msg.buoyFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = actionmsg.msg.buoyFeedback()
